...
import com.hankyong.hankyongsample.model.RestaurantInfoResponse
...
interface JobInfoService {
    ...
    ): BaseResponse<RestaurantInfoResponse> //Todo 샘플은 필요에 의해 BaseResponse 가 사용되었음에 주의.
}
...
class JobInfoServiceImpl @Inject constructor(retrofit: Retrofit) : JobInfoService {
    ...
    override suspend fun getJobInfoList(
        ...
        workAddr: String,
        careerCode: String
    ): BaseResponse<RestaurantInfoResponse> {
