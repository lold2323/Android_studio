...
import com.hankyong.hankyongsample.model.RestaurantInfoRequest
...
class MainViewModel @Inject constructor() : ViewModel() {
    ...
    fun requestSomeInfo(
        ...
        viewModelScope.launch {
            ...
            try {
                //Todo 공공 api 요청 객체.
                val restaurantInfoRequest = RestaurantInfoRequest(
                    //Todo 공공 api 요청에 필요한 값들을 설정 해 줘야함.
                )
                //Todo 공공 api 요청.
                val result = someInfoRepository.getSomeInfoList(restaurantInfoRequest)
