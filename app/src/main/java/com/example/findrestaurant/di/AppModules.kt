...
import com.example.findrestaurant.network.InfoService
import com.example.findrestaurant.network.InfoServiceImpl
import dagger.Binds
...
abstract class ApiModules {
    ...
    @Binds
    abstract fun bindsInfoService(serviceImpl: InfoServiceImpl): InfoService

    @Binds
    abstract fun bindsInfoRepository(repositoryImpl: InfoRepositoryImpl): InfoRepository
}
